...
#Pattern: Two Pointers with Allowed Frequency Constraint
# Generalizable: Allow at most 1 → compare with k-1, Allow at most 2 → compare with k-2
# Allow at most m → compare with k-m, That’s the deeper pattern.
